...
java -javaagent:/sls-mall/opentelemetry-javaagent.jar -Dotel.exporter.otlp.endpoint=${ENDPOINT} -Dotel.java.disabled.resource.providers=io.opentelemetry.sdk.extension.resources.ProcessResourceProvider,io.opentelemetry.sdk.extension.resources.ProcessRuntimeResourceProvider -jar app.jar

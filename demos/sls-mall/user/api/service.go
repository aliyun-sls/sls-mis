...
type Service interface {
	...
	Health(ctx context.Context, logger log.Logger) []Health // GET /health
}
...
func (s *fixedService) Health(ctx context.Context, logger log.Logger) []Health {
	var health []Health
	dbstatus := "OK"
